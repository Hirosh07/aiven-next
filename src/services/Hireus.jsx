...
const HireUsPage = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-center text-[#7A6960] md:text-5xl text-3xl font-semibold my-10 p-5 md:p-0">
        Share your idea & we will <br /> turn it into reality!
      </h1>
      ...
      {/* Newsletter */}
      <section className="w-full py-16 lg:px-32 overflow-hidden bg-[#FEFAF8] border-b border-orange-100 mt-20 md:mt-0">
        <Newsletter />
      </section>

      {/* Footer */}
      <section className="w-full py-16 lg:px-32 overflow-hidden border-b border-orange-100">
        <Footer />
      </section>
    </div>
  );
